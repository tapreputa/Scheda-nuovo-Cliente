(() => {
  ...
  const managed = new Set(['fotografo','gioielleria','macelleria','panineria_hamburgeria','polli_spiedo','toelettaturacani','veterinario']);
  ...
  preview.addEventListener('click', async event => {
    ...
    try {
      ...
      const cfg = {
        ...
        box: 'transparent',
        text: '#ffffff',
        message: id === 'fotografo' ? 'La tua opinione ci aiuta a valorizzare ogni scatto e a migliorare ogni servizio. Raccontaci la tua esperienza! Bastano 2 secondi!' : id === 'toelettaturacani' ? 'La tua opinione ci aiuta a prenderci cura sempre meglio dei nostri amici a 4 zampe. Raccontaci la tua esperienza! Bastano 2 secondi!' : '',
        shift: 'none',
        footerSize: '8px',
        footerStrong: '16px'
      };
