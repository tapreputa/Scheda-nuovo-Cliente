  ...
  preview.addEventListener('click', async event => {
    ...
    try {
      ...
      if (activity.value === 'gioielleria') {
        ...
        html = buildPremiumTemplate(hasLogo ? logoDataUrl : placeholderPixel, reviewUrl, bg, cfg);
        const css = `<style id="polli-spiedo-v1">body{background-color:#2a160c!important;background-size:cover!important;background-position:center top!important;background-repeat:no-repeat!important;background-attachment:fixed!important}.pagina{position:relative!important;min-height:100vh!important;padding:0!important;transform:none!important}.card{position:static!important;padding:0!important;margin:0!important;min-height:100vh!important}.logo{${hasLogo ? 'position:absolute!important;top:2.5vh!important;left:50%!important;transform:translateX(-50%)!important;width:min(185px,52vw)!important;max-height:100px!important;padding:0!important;background:transparent!important;border:0!important;box-shadow:none!important;filter:drop-shadow(0 5px 14px rgba(0,0,0,.45))!important;' : 'display:none!important;'}}.eyebrow{position:absolute!important;top:${hasLogo ? '19vh' : '10vh'}!important;left:5%!important;right:5%!important;max-width:none!important;margin:0!important;font-size:clamp(23px,6.4vw,32px)!important;line-height:1.07!important;letter-spacing:.03em!important;color:#fff!important;text-shadow:0 3px 12px rgba(0,0,0,.9)!important}.messaggio-box{display:none!important}.bottone-google{position:absolute!important;top:69vh!important;left:5%!important;right:5%!important;width:auto!important;margin:0!important;min-height:57px!important;background:linear-gradient(135deg,#e39a45,#a95c21 62%,#c7742c)!important;border:1px solid rgba(255,255,255,.32)!important;box-shadow:0 10px 28px rgba(0,0,0,.32)!important}.stelle{position:absolute!important;top:80vh!important;left:0!important;right:0!important;margin:0!important}footer{font-size:8px!important}footer strong{font-size:16px!important}@media(max-width:640px){.logo{${hasLogo ? 'top:2.3vh!important;width:min(174px,50vw)!important;max-height:94px!important;' : ''}}.eyebrow{top:${hasLogo ? '18.5vh' : '9.5vh'}!important;font-size:clamp(22px,6.8vw,30px)!important}.bottone-google{top:68.5vh!important;min-height:55px!important}.stelle{top:79.5vh!important}}@media(max-height:690px){.eyebrow{top:${hasLogo ? '17vh' : '8.5vh'}!important}.bottone-google{top:66vh!important}.stelle{top:77vh!important}}</style>`;
        html = inject(html, css);
      } else {
