  ...
  preview.addEventListener('click', async event => {
    ...
    try {
      ...
      if (activity.value === 'gioielleria') {
        ...
        html = buildPremiumTemplate(hasLogo ? logoDataUrl : placeholderPixel, reviewUrl, bg, cfg);
        const css = `<style id="panineria-hamburgeria-v5">
          ...
          .stelle{position:absolute!important;z-index:3!important;top:40.5vh!important;left:0!important;right:0!important;margin:0!important}
          .bottone-google{position:absolute!important;z-index:3!important;top:46.5vh!important;left:5%!important;right:5%!important;width:auto!important;margin:0!important;min-height:57px!important;background:linear-gradient(135deg,#e39a45,#a95c21 62%,#c7742c)!important;border:1px solid rgba(255,255,255,.32)!important;box-shadow:0 10px 28px rgba(0,0,0,.3)!important}
          footer{z-index:3!important;font-size:8px!important}footer strong{font-size:16px!important}
          @media(max-width:640px){body{background-size:100% auto!important;background-position:center center!important}.pagina::before{width:32vw!important;height:18vh!important}.logo{${hasLogo ? 'top:2.3vh!important;width:min(174px,50vw)!important;max-height:94px!important;' : ''}}.eyebrow{top:${hasLogo ? '20.5vh' : '10.5vh'}!important;font-size:clamp(22px,6.8vw,30px)!important}.stelle{top:40.5vh!important}.bottone-google{top:46.8vh!important;min-height:55px!important}}
          @media(max-height:690px){.eyebrow{top:${hasLogo ? '19.5vh' : '9.5vh'}!important}.stelle{top:39vh!important}.bottone-google{top:45.5vh!important}}
        </style>`;
        html = inject(html, css);
      } else {
