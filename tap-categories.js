(() => {
  ...
  const categories = [
    ...
    { id:'beb', label:'B&B Isola', background:'Sfondohotel.png', title:'Ti è piaciuto il tuo soggiorno da noi?', accent:'#c8a47e', accent2:'#8f6e50', theme:'#3a3028', approvedAt:'2026-09-18', description:'Sfondo B&B premium con camera accogliente, colazione e atmosfera mediterranea + layout dedicato con spazio per logo, titolo, didascalia, pulsante recensioni e 5 stelle + Powered by Tapreputa.' },
    ...
    { id:'enoteca', label:'Enoteca', background:'Sfondoenoteca.png', title:'La nostra selezione di vini ti ha conquistato?', accent:'#9b4a3c', accent2:'#623126', theme:'#2a1b17', approvedAt:'2026-09-18', description:'Sfondo enoteca rustico-premium con archi in pietra, bottiglie, botti e luce calda + layout dedicato che preserva la profondità centrale della scena + pulsante recensioni + 5 stelle + Powered by Tapreputa.' },
    ...
    { id:'lavanderia', label:'Lavanderia', background:'Sfondolavanderia.png', title:'Il nostro servizio di lavanderia ti ha soddisfatto?', accent:'#8cb8d8', accent2:'#5e87a5', theme:'#dfeaf2', approvedAt:'2026-09-19', description:'Sfondo lavanderia moderna, luminosa e minimalista + layout dedicato con palette azzurro ghiaccio/bianco e massima visibilità dell’ambiente + pulsante recensioni + 5 stelle + Powered by Tapreputa.' },
    ...
    { id:'petfood', label:'Negozio di animali / Pet Food', background:'Sfondopetfood.png', title:'Hai trovato tutto per il tuo amico animale?', accent:'#c9a47c', accent2:'#8f6a47', theme:'#2e2a25', approvedAt:'2026-09-18', description:'Sfondo pet shop premium con mangimi, acquari, tartarughine e uccellini + layout dedicato con spazio per logo, titolo, didascalia, pulsante recensioni e 5 stelle + Powered by Tapreputa.' },
    ...
    { id:'studiotatuaggi', label:'Studio tatuaggi', background:'Sfondostudiotatuaggi.png', title:'Sei soddisfatto del tuo nuovo tatuaggio?', accent:'#c98b52', accent2:'#7b4a2b', theme:'#241b16', approvedAt:'2026-09-18', description:'Sfondo studio tatuaggi premium con parete antracite, postazione professionale e luci ambrate + layout dedicato che preserva gli elementi caratteristici dello studio + pulsante recensioni + 5 stelle + Powered by Tapreputa.' },
