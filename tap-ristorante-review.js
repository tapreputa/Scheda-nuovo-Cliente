(() => {
  ...
  openInlinePreview = function(html) {
    ...
    if (type === 'ristorante' && typeof html === 'string') {
      if (noLogo) {
        ...
        html = html.replace('</head>', `<style id="tap-ristorante-with-logo-review-v1">
          .eyebrow{
            font-size:clamp(1.22rem,5.4vw,1.58rem)!important;
            line-height:1.12!important;
            font-weight:950!important;
            letter-spacing:.04em!important;
            color:#fff!important;
            text-shadow:0 3px 11px rgba(0,0,0,.9)!important;
          }
          .messaggio-box{
            background:rgba(245,238,228,.47)!important;
            border-color:rgba(255,255,255,.30)!important;
            backdrop-filter:blur(.9px)!important;
            -webkit-backdrop-filter:blur(.9px)!important;
            box-shadow:0 8px 22px rgba(0,0,0,.16)!important;
          ...
          @media(max-width:640px){
            .eyebrow{font-size:clamp(1.18rem,5.2vw,1.48rem)!important}
            .messaggio-box{background:rgba(245,238,228,.49)!important}
          }
        </style></head>`);
      }
    }
