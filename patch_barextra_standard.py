...
# --- personalizza.html: Bar extra usa lo stesso asset della pagina finale e lo incorpora
# come Data URL nell'anteprima. Manteniamo il background-image originale e aggiungiamo
# anche un livello <img> dedicato come fallback visuale.
...
branch = '''    } else if (type === "barextra") {
      const backgroundDataUrl = await loadBackgroundDataUrl("Sfondobarextra.webp?v=20260911-0015");
...
# --- tap-auth.js: vecchi override runtime Bar extra restano disattivati.
p = Path('tap-auth.js')
...
print('Bar extra: anteprima con sfondo incorporato e navigazione senza cache')
